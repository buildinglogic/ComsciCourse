...
int main(int argc, char* argv[])
{
	...
	tinfo[0].argv_string = strdup("sw.in0");
	tinfo[1].argv_string = strdup("sw.in1");
	tinfo[2].argv_string = strdup("sw.in2");
	tinfo[3].argv_string = strdup("sw.in3");
	tinfo[4].argv_string = strdup("sw.in4");
